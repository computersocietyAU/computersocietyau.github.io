...
const Team = () => {
  ...
  return (
    <div>
        <br></br>
        <br></br>
      <img src={logo} className=' mr-0 mt-6  w-48 h-32 mob:mt-12 k:mt-0 lg:w-fit lg:h-fit '></img>
      <div className='flex flex-col py-10 '>
        <img src={our_team} className=' mb-6 mt-10 w-4/5 lg:w-fit lg:h-fit mx-auto'></img>
        <br></br>
        <img src={presidents} className=' my-6 w-2/5 mx-auto lg:my-7 text-center' ></img>
            ...
            Presidents.map((i) => {
              return (
                <div className='rounded-full  my-4  gap-2 tab:w-40 tab:h-40 2k:w-96 2k:h-96 2k:gap-10 2k:m-10   text-sm w-28 h-28 k:w-56 k:h-56 xl:w-64 xl:h-64 flex k:text-2xl k:my-1 tab:my-0.5 flex-col group relative overflow-hidden transition-all  '>
                  <img src={i.pic} className=' scale-125 group-hover:blur-sm group-hover:brightness-75 group-hover:scale-100 font-pop  transition-all rounded-full h-full  w-full  '></img>
                  <div className=' absolute invisible group-hover:visible 2x:m-10 lg:text-xl -translate-x-2/4 flex  flex-col   -translate-y-2/4 top-2/4 left-2/4 text-white'>
                    <h1 className=' text-center k:text-2xl 2k:text-3xl 2k:m-4 tab:text-xs tab:m-2 '>{i.name}</h1>
                    <h1 className='text-center k:text-xl  m-2 2k:text-3xl 2k:m-4 tab:text-xs tab:m-3' >CSE {i.year}</h1>
        ...
        <img src={domain_heads} className=' w-2/5    mx-auto mb-12 mt-10 text-center' ></img>
              ...
              return (
                <div className='rounded-full my-4  k:text-xl tab:w-40 tab:h-40 tab:text-xs text-tiny 2k:w-96 2k:h-96 2k:gap-10 2k:m-10 2k:text-3xl xl:w-96 xl:h-96  w-20 h-20 k:w-56 k:h-56  flex  flex-col group relative overflow-hidden transition-all  '>
                  ...
                  <div className=' absolute invisible group-hover:visible -translate-x-2/4 flex flex-col   -translate-y-2/4 top-2/4 left-2/4 text-white'>
                    <h1 className=' text-center m-0.5 2k:m-4 tab:m-1'>{i.name}</h1>
                    <h1 className='text-center m-0.5  k:m-2 2k:m-4 tab:m-1' >CSE {i.year}</h1>
                    <h1 className='text-center m-0.5 k:m-2 2k:m-4 tab:m-1' >{i.Domain}</h1>
        ...
        <img src={core_members} className=' w-2/5  mt-12   mx-auto lg:my-7  text-center' ></img>
